...
;.include "C:\Program Files (x86)\Atmel\Atmel Studio 6.0\extensions\Atmel\AVRAssembler\2.1.51.24\avrassembler\include\m8def.inc"
.equ	LCD_RS	= 1
.equ	LCD_RW	= 2
.equ	LCD_E	= 3
