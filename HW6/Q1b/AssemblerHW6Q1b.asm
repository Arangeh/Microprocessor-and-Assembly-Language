...
andi r16, ~(1 << cs01)
;we have determined CTC mode by altering WGM01, WGM00 bits
andi r16, ~(1 << wgm00)
ori r16, (1 << wgm01)
;in CTC mode, COM01:00 should be set as 0 and 1 respectively
;if we want to toggle OC0 on each compare match in Timer/Counter0
andi r16, ~(1 << com01)
ori r16, (1 << com00)
